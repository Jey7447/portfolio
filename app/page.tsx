    ...
    <main className="home-page">
      ...
      <section id="contact" className="home-contact wrap">
        <div className="home-contact-copy">
          <div className="home-contact-index"><span>CONTACT / 01</span><span>SELECTED PROJECTS</span></div>
          <span className="home-kicker">HAVE A PROJECT IN MIND?</span>
          <h2>Let&apos;s build<br /><em>something useful.</em></h2>
          <p>Tell me what you&apos;re trying to build, automate or improve. We can turn the idea into a clear technical path.</p>
        </div>
        <div className="home-contact-card">
          <div className="home-contact-top"><Terminal size={17} /><span>START A CONVERSATION</span><i>OPEN</i></div>
          <a className="home-contact-link" href="mailto:jessebriska2@gmail.com">jessebriska2@gmail.com <ArrowUpRight size={18} /></a>
          <div className="home-contact-meta"><span>PROJECT TYPES</span><strong>SOFTWARE · AUTOMATION · SYSTEMS</strong></div>
          <div className="home-socials"><a href="https://github.com/Jey7447" target="_blank" rel="noreferrer"><Github size={16} /> GitHub</a><a href="https://www.linkedin.com/in/briska-jesse-a8b864322/" target="_blank" rel="noreferrer"><Linkedin size={16} /> LinkedIn</a><a href="https://x.com/JBART7447" target="_blank" rel="noreferrer"><span aria-hidden="true" className="home-x-icon">𝕏</span> X</a><a href="https://wa.me/2349033019841" target="_blank" rel="noreferrer"><MessageCircle size={16} /> WhatsApp</a><a href="#work"><ArrowDown size={16} /> View work</a></div>
        </div>
      </section>
