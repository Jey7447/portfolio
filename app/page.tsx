  ...
  return (
    <main className="home-page">
      ...
      <section id="contact" className="home-contact wrap">
        ...
        <div className="home-contact-card"><div className="home-contact-top"><Terminal size={17} /><span>START A CONVERSATION</span></div><a className="home-contact-link" href="mailto:hello@jessebriska.dev">hello@jessebriska.dev <ArrowUpRight size={18} /></a><div className="home-socials"><a href="https://github.com/Jey7447" target="_blank" rel="noreferrer"><Github size={16} /> GitHub</a><a href="#" aria-label="LinkedIn profile coming soon"><Linkedin size={16} /> LinkedIn</a><a href="mailto:hello@jessebriska.dev"><Mail size={16} /> Email</a></div></div>
      </section>
