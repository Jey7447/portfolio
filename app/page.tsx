...
const services = [
  {
    ...
    text: "Fast, responsive websites and web applications built around real business requirements.",
  },
  {
    icon: Workflow,
    title: "AI & Automation",
    text: "Workflow systems, API integrations and AI-assisted processes that remove repetitive work.",
  },
  {
    icon: Database,
    title: "Backend & Systems",
    text: "Reliable databases, authentication, APIs and application architecture that can grow with the product.",
  },
];

const processSteps = [
  ["01", "Understand", "Start with the problem, the users and the business constraint."],
  ["02", "Design", "Map the experience, data and system architecture before building."],
  ["03", "Build", "Develop the product in small, testable pieces with the right tools."],
  ["04", "Automate", "Connect services, APIs and workflows where manual work can disappear."],
  ["05", "Ship", "Deploy, verify and improve based on what happens in the real world."],
];
    ...
    <main>
      ...
      <section id="top" className="hero wrap">
        ...
        >
          I build digital
          <br />
          <em>systems</em> that work.
        </motion.h1>

        <div className="hero-bottom">
          <p>
            Full-stack development, AI automation and backend systems for
            businesses that need more than a pretty interface.
          </p>
      ...
      <section className="marquee">
        <div>
          SOFTWARE <span>✦</span> AUTOMATION <span>✦</span> SYSTEMS{" "}
          <span>✦</span> SOFTWARE <span>✦</span> AUTOMATION <span>✦</span>{" "}
          SYSTEMS <span>✦</span>
        </div>
      </section>
      ...
      <section id="work" className="section wrap">
        <div className="sectionhead">
          ...
          <p>
            Real systems, real constraints, real implementation. Each project
            is a look at how I approach problems from interface to
            infrastructure.
          </p>
        </div>
      ...
      <section id="services" className="section services-section">
        <div className="wrap">
          <div className="sectionhead">
            ...
            <p>
              Technology is the tool. The goal is a system that makes the
            ...
            {services.map((service, i) => {
              ...
              return (
                ...
                >
                  ...
                  <ArrowUpRight className="servicearrow" />
                </motion.div>
              );
            })}
          </div>
      ...
      <section id="process" className="section wrap process">
        <div className="sectionhead">
          ...
          <p>
            A clear process keeps technical decisions connected to the outcome.
            No black box, no unnecessary complexity.
          </p>
        </div>
          ...
          {processSteps.map((step, i) => (
            <div className="step" key={step[0]}>
              ...
              {i < processSteps.length - 1 && (
                <ArrowDown className="stepicon" size={18} />
              )}
            </div>
          ))}
        </div>
      ...
      <section className="manifesto">
        <div className="wrap">
          ...
          <p>Complexity belongs behind the interface — not in the experience.</p>
        </div>
      </section>

      <section id="contact" className="contact wrap">
        <div className="contactcopy">
          <span className="kicker">HAVE A PROBLEM WORTH SOLVING?</span>
          <h2>
            Let&apos;s build
            <br />
          ...
          <p>
            ...
            I&apos;ll help turn the idea into a clear technical path.
          </p>
        </div>
        ...
        <div className="contactcard">
          ...
          <a
            href="https://github.com/Jey7447"
            target="_blank"
            rel="noreferrer"
            className="email"
          >
            github.com/Jey7447 <ArrowUpRight />
          </a>
          ...
          <div className="socials">
            ...
            <a href="#" aria-label="LinkedIn profile coming soon">
